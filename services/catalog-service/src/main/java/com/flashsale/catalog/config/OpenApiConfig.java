...
public class OpenApiConfig {
    ...
    OpenAPI serviceOpenApi() {
        ...
        OpenAPI api = new OpenAPI()
                .info(new Info().title("FlashSale — Catalog Service").version("v1")
                        .description("Browse published products without logging in. Product management and hidden-product previews require an ADMIN bearer token. DELETE hides a product and preserves its record."))
