...
public class OpenApiConfig {
    ...
    OpenAPI serviceOpenApi() {
        ...
        OpenAPI api = new OpenAPI()
                .info(new Info().title("FlashSale — API Gateway").version("v1")
                        .description("Select a service in the definition dropdown to test its APIs. Requests are proxied through this gateway to the selected service."))
